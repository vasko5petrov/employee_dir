                ...
                <div class="card-content">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                <input type="date" class="datepicker birthday" name="em-birthday" value="{{ old('em-birthday') }}" id="em-birthday" autofocus>
                            ...
                            <div class="input-field col s12">
                                <input type="text" class="validate{{ $errors->first('em-job-title') ? ' animated shake' : '' }}" data-error="{{ $errors->first('em-job-title') }}" name="em-job-title" value="{{ old('em-job-title') }}" id="em-job-title">
                            ...
                            <div class="input-field col s12">
                                <input type="email" class="validate{{ $errors->first('em-email') ? ' animated shake' : '' }}" data-error="{{ $errors->first('em-email') }}" name="em-email" value="{{ old('em-email') }}" id="em-email">
                            ...
                            <div class="input-field col s12">
                                <input type="text" class="validate{{ $errors->first('em-phone-number') ? ' animated shake' : '' }}" data-error="{{ $errors->first('em-phone-number') }}" name="em-phone-number" value="{{ old('em-phone-number') }}" id="em-phone-number">
                            ...
                            <div class="input-field col s12">
                                <input type="date" class="datepicker" name="em-hiringDate" value="{{ old('em-hiringDate') }}" id="em-hiringDate" autofocus>
