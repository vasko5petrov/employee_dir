                ...
                <div class="panel-body" style="padding: 50px;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker birthday" name="em-birthday" value="{{ $em->birthday }}" id="em-birthday" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="datepicker form-control" name="em-hiringDate" value="{{ $em->hiring_day }}" id="em-hiringDate" autofocus>
